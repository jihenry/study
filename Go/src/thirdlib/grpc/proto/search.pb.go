...
var fileDescriptor_453745cff914010e = []byte{
	...
	0x23, 0x0f, 0x90, 0xc1, 0x45, 0x65, 0x99, 0xc9, 0xa9, 0x10, 0x4d, 0x42, 0xe6, 0x5c, 0x6c, 0x50,
	0x96, 0x08, 0xc4, 0x09, 0x7a, 0x28, 0x16, 0x4b, 0x89, 0xa2, 0x89, 0x42, 0xcc, 0x51, 0x62, 0x48,
	0x62, 0x03, 0x8b, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xf0, 0xcc, 0x77, 0x2a, 0xc0, 0x00,
	0x00, 0x00,
}
...
func (c *serviceSearchClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := c.cc.Invoke(ctx, "/proto.ServiceSearch/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedServiceSearchServer) Search(ctx context.Context, req *SearchRequest) (*SearchResponse, error) {
...
func _ServiceSearch_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceSearchServer).Search(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceSearch/Search",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceSearchServer).Search(ctx, req.(*SearchRequest))
	}
...
var _ServiceSearch_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Search",
			Handler:    _ServiceSearch_Search_Handler,
		},
	},
